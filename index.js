...
const shouldDeploy = environment === "production" && !watchEnabled && argv.deploy;
...
const metadata = Object.assign(require("./metadata"), {environment, watchEnabled});
...
Metalsmith(__dirname)
    ...
    .build((err) => {
        ...
        if (shouldDeploy) {
            ...
            ghpages.publish(buildDirectory, {
